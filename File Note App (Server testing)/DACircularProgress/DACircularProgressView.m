...
+ (void) initialize
{
    if (self == [DACircularProgressView class]) {
        ...
        [circularProgressViewAppearance setTrackTintColor:[[UIColor whiteColor] colorWithAlphaComponent:0.1f]];
        [circularProgressViewAppearance setProgressTintColor:[UIColor colorWithRed:65.0/255 green:127.0/255 blue:6.0/255 alpha:1.0]];
